  ...
  return (
    <div className="w-full mx-auto">
      <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
        {apiError && (
          <div className="bg-red-50 border border-red-200 text-red-700 px-3 sm:px-4 py-3 rounded-lg text-sm flex items-start gap-2.5 shadow-sm">
            ...
            <span className="font-medium leading-5">{apiError}</span>
          </div>
        )}
        ...
        <Button
          type="submit"
          className="w-full text-base sm:text-lg py-3 mt-2 sm:mt-4"
