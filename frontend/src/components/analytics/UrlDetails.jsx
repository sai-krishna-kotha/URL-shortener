    ...
    <Card className="overflow-hidden">
      ...
      <div className="px-4 sm:px-6">
        <dl className="divide-y divide-gray-200">
          <div className="py-4 grid grid-cols-[130px_minmax(0,1fr)] sm:grid-cols-[150px_minmax(0,1fr)] gap-3 sm:gap-6 items-start">
          ...
          <div className="py-4 grid grid-cols-[130px_minmax(0,1fr)] sm:grid-cols-[150px_minmax(0,1fr)] gap-3 sm:gap-6 items-start">
            ...
            <dd className="text-sm text-gray-900 min-w-0">
              <a href={stats.target_url} target="_blank" rel="noopener noreferrer" className="break-all hover:underline hover:text-indigo-600" title={stats.target_url}>
                {stats.target_url}
              </a>
            </dd>
          </div>
