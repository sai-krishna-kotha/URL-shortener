    ...
    <header className="bg-white border-b border-gray-200">
      <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 min-h-16 py-2 flex flex-wrap items-center justify-between gap-3">
        ...
        >
          ...
          <span className="font-bold text-sm sm:text-lg tracking-tight text-gray-900 truncate">
            URL Shortener
          </span>
        </Link>
        ...
        <nav className="flex items-center gap-1 sm:gap-3" aria-label="Primary navigation">
          <Link
            to="/"
            className={`text-xs sm:text-sm font-medium transition-colors px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
              location.pathname === '/'
